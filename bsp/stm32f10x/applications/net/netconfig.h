...
#define SHOW_RECV_MSG_INFO          1 //显示接收报文信息
...
#define SHOW_WND_INFO               1 //显示报文发送窗口处理信息
#define SHOW_SET_MSG_INOF           0 //显示设置报文数据过程的信息
#define SHOW_RECV_MAIL_ADDR         1 //显示接收数据邮箱的内存地址
#define SHOW_NONE_ENC_DATA          1 //显示没有加密的数据

//网络文件
#define SHOW_NFILE_CRC32            1 //显示文件的crc32校验值
